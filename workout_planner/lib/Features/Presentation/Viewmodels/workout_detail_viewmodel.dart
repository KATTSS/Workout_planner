...
class WorkoutDetailViewModel {
  ...
  Future<bool> saveWorkout() async {
    ...
    try {
      ...
      _ref.read(workoutSessionProvider.notifier).save();
      return true;
    } catch (e) {
      return false;
    }
  ...
  void updateSet(int exerciseId, int setIndex, SetData newSet) {
    _ref.read(workoutSessionProvider.notifier).updateSet(exerciseId, setIndex, newSet);
  }
...
final workoutDetailViewModelProvider = Provider.family<WorkoutDetailViewModel, Workout>((ref, workout) {
