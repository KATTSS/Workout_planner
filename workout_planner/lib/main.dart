...
import 'package:workout_planner/Features/Data/Repository/excercise_repo_realisation.dart'; // Добавлен
import 'package:workout_planner/Features/Data/Service/excercise_db.dart'; // Добавлен
...
void main() async {
  // Гарантируем инициализацию связей с платформой
  WidgetsFlutterBinding.ensureInitialized();

  // 1. Инициализируем БД для записи
  await UserHistDb.instance.init();

  // 2. БД упражнений (ReadOnly) инициализируется лениво при первом обращении,
  // но мы можем проверить её работу сразу в UI.
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _runDiagnostics() async {
    ...
    try {
      ...
      // --- ПРОВЕРКА 2: База истории (Read/Write) ---
